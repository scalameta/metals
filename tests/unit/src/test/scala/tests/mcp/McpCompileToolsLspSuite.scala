...
class McpCompileToolsLspSuite
  ...
  test("compile-file-with-warnings") {
    ...
    for {
      ...
      _ = assertNoDiff(
        result1,
        """|Found warnings in /Users/tgodzik/Documents/metals/tests/unit/target/e2e/mcp-compile-tools/compile-file-with-warnings/a/src/main/scala/com/example/Hello.scala:
