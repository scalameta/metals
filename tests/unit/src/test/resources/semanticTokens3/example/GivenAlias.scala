...
<<given>>/*keyword*/ (<<using>>/*keyword*/ <<i>>/*parameter,declaration*/: <<Int>>/*class,abstract*/): <<Double>>/*class,abstract*/ = <<4.0>>/*number*/
<<given>>/*keyword*/ [<<T>>/*typeParameter,definition,abstract*/]: <<List>>/*type*/[<<T>>/*typeParameter,abstract*/] = <<Nil>>/*variable,readonly*/
...
<<given>>/*keyword*/ [<<T>>/*typeParameter,definition,abstract*/]: <<Zg>>/*interface,abstract*/[<<T>>/*typeParameter,abstract*/] <<with>>/*keyword*/
  <<def>>/*keyword*/ <<doZ>>/*method,definition*/: <<List>>/*type*/[<<T>>/*typeParameter,abstract*/] = <<Nil>>/*variable,readonly*/
