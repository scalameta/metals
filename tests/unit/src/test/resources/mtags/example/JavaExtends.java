...
/*example.JavaExtends#Color#RED.*/		RED("red"), GREEN/*example.JavaExtends#Color#GREEN.*/("green"), BLUE/*example.JavaExtends#Color#BLUE.*/("blue");

/*example.JavaExtends#Color#`<init>`().*/		private final String name/*example.JavaExtends#Color#name.*/;
