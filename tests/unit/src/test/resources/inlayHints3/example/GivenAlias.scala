...
/*x$1<<example/GivenAlias$package.given_Yg().(x$1)>>(*//*)*/given (using Xg): Yg with
...
val x/*: given_Xg<<example/GivenAlias$package.given_Xg.>>*/ = given_Xg
val y/*: given_Yg<<example/GivenAlias$package.given_Yg#>>*/ = given_Yg/*(given_Xg<<example/GivenAlias$package.given_Xg.>>)*/
val z/*: given_Zg_T<<example/GivenAlias$package.given_Zg_T#>>[String<<scala/Predef.String#>>]*/ = given_Zg_T[String]