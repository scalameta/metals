...
class SemanticTokensSuite extends BaseSemanticTokensSuite {
  ...
  check(
    ...
    s"""|package <<example>>/*namespace*/
        ...
        |object <<testC>>/*class*/{
        |
        | def <<bc>>/*method,definition*/(<<msg>>/*parameter,declaration*/:<<String>>/*type*/)={
  ...
  check(
    ...
    s"""|package <<example>>/*namespace*/
        ...
        |
        |  def <<add>>/*method,definition*/(<<a>>/*parameter,declaration*/ : <<Int>>/*class,abstract*/) = {
        |    // Single Line Comment
  ...
  check(
    ...
    s"""|package <<example>>/*namespace*/
        ...
        |  def <<main>>/*method,definition*/(<<args>>/*parameter,declaration*/: <<Array>>/*class*/[<<String>>/*type*/]) ={
        |    <<println>>/*method*/(
  ...
  check(
    ...
    s"""|
        ...
        |    def <<log>>/*method,definition*/(<<str>>/*parameter,declaration*/:<<String>>/*type*/) = {<<println>>/*method*/(<<str>>/*parameter*/)}
        |  }
        |
  ...
  check(
    ...
    s"""|package <<example>>/*namespace*/
        ...
        |  def <<oldMethod>>/*method,definition,deprecated*/(<<x>>/*parameter,declaration*/: <<Int>>/*class,abstract*/) = <<x>>/*parameter*/
        |
        |  def <<main>>/*method,definition*/(<<args>>/*parameter,declaration*/: <<Array>>/*class*/[<<String>>/*type*/]) ={
  ...
  check(
    ...
    s"""|package <<example>>/*namespace*/
        ...
        |
        |  def <<sorted1>>/*method,definition*/(<<x>>/*parameter,declaration*/: <<Int>>/*class,abstract*/)
  ...
  check(
    ...
    s"""|package <<example>>/*namespace*/ 
        ...
        |    def <<method>>/*method,declaration,abstract*/(<<asf>>/*parameter,declaration*/: <<T>>/*typeParameter,abstract*/): <<Int>>/*class,abstract*/
        |  }
        |
        ...
        |    def <<method>>/*method,definition*/(<<adf>>/*parameter,declaration*/: <<String>>/*type*/) = 123
        |  }
        |  val <<a>>/*variable,definition,readonly*/ = new <<Alp>>/*class,abstract*/(<<alp>>/*parameter*/ = 10) {
        |    override def <<method>>/*method,definition*/(<<adf>>/*parameter,declaration*/: <<String>>/*type*/): <<Int>>/*class,abstract*/ = 321
        |  }
        |}""".stripMargin,
    ...
    compat = Map(
      "3" -> s"""|package <<example>>/*namespace*/ 
                 ...
                 |    def <<method>>/*method,declaration*/(<<asf>>/*parameter,declaration*/: <<T>>/*typeParameter,abstract*/): <<Int>>/*class,abstract*/
                 |  }
                 |
                 |  abstract class <<Alp>>/*class,abstract*/(<<alp>>/*variable,declaration,readonly*/: <<Int>>/*class,abstract*/) extends <<Methodable>>/*interface,abstract*/[<<String>>/*type*/] {
                 |    def <<method>>/*method,definition*/(<<adf>>/*parameter,declaration*/: <<String>>/*type*/) = 123
