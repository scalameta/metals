 ...
 */
final case class MetalsConfigurationProperties(
    ...
    snippetAutoIndent: Boolean = MetalsConfigurationProperties.binaryOption(
      "metals.snippet-auto-indent",
      default = true
    ),
    isExitOnShutdown: Boolean = MetalsConfigurationProperties.binaryOption(
      "metals.exit-on-shutdown",
      default = false
    ),
    isHttpEnabled: Boolean = MetalsConfigurationProperties.binaryOption(
      "metals.http",
      default = false
    ),
    isInputBoxEnabled: Boolean = MetalsConfigurationProperties.binaryOption(
      "metals.input-box",
      default = false
    ),
    isVerbose: Boolean = MetalsConfigurationProperties.binaryOption(
      "metals.verbose",
      default = false
    ),
    isAutoServer: Boolean = MetalsConfigurationProperties.binaryOption(
      "metals.h2.auto-server",
      default = true
    ),
    isWarningsEnabled: Boolean = MetalsConfigurationProperties.binaryOption(
      "metals.warnings",
      default = true
    ),
...
object MetalsConfigurationProperties {
  ...
  def base: MetalsConfigurationProperties = MetalsConfigurationProperties()
  def default: MetalsConfigurationProperties = {
