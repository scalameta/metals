...
final class Debugger(
    server: RemoteServer,
    retrieveOutputs: () => Seq[OutputEventArguments],
    retrieveNotifications: () => Seq[NotificationMessage]
  ...
  def getOutputs(): Seq[OutputEventArguments] = {
    retrieveOutputs()
  }

  def getNotifications(): Seq[NotificationMessage] = {
