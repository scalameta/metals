object TestGroups {
  ...
  val testGroup1 = Set("tests.RenameLspSuite", "tests.ImplementationLspSuite",
    ...
    "tests.NewFilesLspSuite", "tests.CascadeLspSuite",
    ...
    "tests.FoldingRangeSuite", "tests.pants.PantsSuite", "tests.JavadocSuite",
  ...
  val testGroup2 = Set("tests.AmmoniteSuite", "tests.debug.BreakpointDapSuite",
    ...
    "tests.WorkspaceSymbolLspSuite", "tests.RangeFormattingWhenSelectingSuite",
    "tests.AddPackageLspSuite", "tests.WarningsLspSuite",
    "tests.BspSwitchLspSuite", "tests.codeactions.CreateNewSymbolLspSuite",
