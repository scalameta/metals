object TestGroups {
  ...
  val allTests = List(
    ...
    "tests.HoverWikiLinkLspSuite", "tests.SuperHierarchyLspSuite",
    "tests.DidFocusLspSuite", "tests.BuildServerConnectionLspSuite",
    "tests.BuildTargetsLspSuite", "tests.FileWatcherLspSuite",
    "tests.CurrentProjectCompileLspSuite", "tests.WindowStateDidChangeLspSuite",
    "tests.DocumentSymbolLspSuite", "tests.WorkspaceSymbolExpectSuite",
    "tests.digest.DigestsSuite", "tests.MtagsSuite",
    "tests.ChosenBuildServerSuite", "tests.SemanticdbSuite",
    ...
    "tests.MarkdownGeneratorSuite", "tests.SkipCommentsSuite",
