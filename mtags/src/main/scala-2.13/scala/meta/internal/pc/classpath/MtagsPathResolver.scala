 ...
 *
 * https://github.com/scala/scala/blob/v2.13.16/src/compiler/scala/tools/util/PathResolver.scala#L210
 */
final class MtagsPathResolver(
  ...
  object Calculated {
     ...
     */
    def sourcePath: String = if (!settings.isScaladoc)
