 ...
 *
 * <p>
 * Most parts of this file have been adapted from the companion Scala
 * implementation:
 *
 * <p>
...
public final class SemanticdbSymbols {
	...
	public static String global(String owner, Descriptor desc) {
		...
		else if (!ROOT_PACKAGE.equals(owner))
			return owner + desc.encode();
		else
			return desc.encode();
	}
	...
	public static final class Descriptor {
		...
		public enum Kind {
			None, Local, Term, Method, Type, Package, Parameter, TypeParameter;
		}
		...
		public String toString() {
			return "Descriptor{" + "kind=" + kind + ", name='" + name + '\'' + ", disambiguator='" + disambiguator
					+ '\'' + '}';
		}
		...
		/**
		 * Wraps non-alphanumeric identifiers in backticks, according to the SemanticDB
		 * spec.
		 */
