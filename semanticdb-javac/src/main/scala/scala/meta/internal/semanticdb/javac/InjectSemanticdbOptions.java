...
public class InjectSemanticdbOptions {
	 ...
	 * <li>-Dsemanticdb.old-output=PATH: the file to write the original compiler
	 * options. Only used for debugging purposes.
	 * <li>-Dsemanticdb.pluginpath=PATH: the path to the SemanticDB compiler plugin
	 * jar
	 * <li>-Dsemanticdb.sourceroot=PATH: the path to use in -Xplugin:semanticdb
	 * -sourceroot:PATH
	 * <li>-Dsemanticdb.targetroot=PATH: the path to use in -Xplugin:semanticdb
	 * -targetroot:PATH
	 * </ul>
	 *
