...
- multiline string can now be formated exclusively when using `format selection`
  on that string
- add in `...` to signify truncation in worksheets
- fix hover on Scala App trait and several other cases that showed up on Scala
  Play projects
- messages about upgrading Scala versions are now more valid to the user
- sort references in a file before showing them
...
## [v0.8.4](https://github.com/scalameta/metals/tree/v0.8.4) (2020-03-20)
