...
current line and to un-truncate multi-line error messages.
...
Thanks to [tomv564/LSP#470](https://github.com/tomv564/LSP/pull/470), it's now
possible to respond to the "Import build" dialogue from Sublime Text without
using the HTTP server. Big thanks to
[@ayoub-benali](https://github.com/ayoub-benali) for this contribution.
