...
Protocol](../lsp-extensions/debug-adapter-protocol.md).
...
Protocol](../lsp-extensions/tree-view-protocol.md).
...
editor, see the [Debug Adapter Protocol](../lsp-extensions/debug-adapter-protocol.md).

### Tree View Protocol

Metals implements several custom JSON-RPC endpoints related to rendering tree
views in the editor client, the [Tree View Protocol](../lsp-extensions/tree-view-protocol.md).

### Decoration Protocol

Metals implements an LSP extension to display non-editable text in the editor,
see the [Decoration Protocol](../lsp-extensions/decoration-protocol.md).
