...
public interface SymbolDocumentation {
  ...
  /**
   * The human-readable name of this symbol, does not for example include backticks for identifiers
   * with spaces.
   */
  String displayName();
   ...
   *
   * <p>For example, for `def sliding(n: Int = 2)` the default value is `2` for the `n` parameter.
   */
  String defaultValue();
   ...
   *
   * <p>Returns a flattened list of Scala curried methods.
   */
