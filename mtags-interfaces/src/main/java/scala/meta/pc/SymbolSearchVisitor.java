 ...
 *
 * <p>Search results can come from two different sources: classpath or workspace. Classpath results
 * are symbols defined in library dependencies while workspace results are symbols that are defined
 * by the user.
 */
public abstract class SymbolSearchVisitor {
   ...
   */
  public abstract boolean shouldVisitPackage(String pkg);
   ...
   */
  public abstract int visitClassfile(String pkg, String filename);
