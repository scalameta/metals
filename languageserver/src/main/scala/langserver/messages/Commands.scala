...
@JsonCodec case class CompletionOptions(resolveProvider: Boolean, triggerCharacters: Seq[String])
...
@JsonCodec case class DocumentOnTypeFormattingOptions(firstTriggerCharacter: String, moreTriggerCharacters: Seq[String])
@JsonCodec case class ExecuteCommandOptions(commands: Seq[String])
@JsonCodec case class CompletionList(isIncomplete: Boolean, items: Seq[CompletionItem])
...
@JsonCodec case class ApplyWorkspaceEditParams(label: Option[String], edit: WorkspaceEdit)
...
@JsonCodec case class PublishDiagnostics(uri: String, diagnostics: Seq[Diagnostic])
...
@JsonCodec case class DidCloseTextDocumentParams(textDocument: TextDocumentIdentifier)
@JsonCodec case class DidSaveTextDocumentParams(textDocument: TextDocumentIdentifier)
...
@JsonCodec case class RenameResult(params: WorkspaceEdit)
...
@JsonCodec case class SignatureHelp(signatures: Seq[SignatureInformation],
